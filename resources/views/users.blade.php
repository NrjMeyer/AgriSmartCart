                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            ...
                            <a href="" class="btn btn-success " h><i class="fa fa-plus"
                                    ...
                                    <tbody>
                                        <tr>
                                            @foreach ($users as $user)
                                                <td>
                                                    <div class="d-flex px-2 py-1">
                                                        ...
                                                        <div class="d-flex flex-column justify-content-center">
                                                            <p class="text-xs font-weight-bold mb-0">{{ $user->nom }}
                                                            </p>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="align-middle text-left">
                                                    <span
                                                        class="badge badge-sm bg-gradient-success">{{ $user->role }}</span>
                                                </td>
                                                <td class="align-middle text-center">
                                                    <span
                                                        class="text-secondary text-xs font-weight-bold">{{ $user->adresse }}</span>
                                                </td>
                                                ...
                                                <td class="align-middle">
                                                    <a class="btn btn-link text-danger text-gradient px-3 mb-0"
                                                        href="javascript:;" data-id="" data-toggle="modal"
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title"
                                                                        id="confirmationModalLabel">Confirmation de la
                                                                        suppression</h5>
