          ...
          <div class="row">
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
              <div class="card card-plain">
                ...
                <div class="card-body">
                  <form role="form" method="post" action="{{ url('/ajouter-utilisateur') }}">
                  @csrf
                  <div class="mb-3">
                      <input type="text" class="form-control form-control-lg" placeholder="Nom" aria-label="nom" name="nom">
                    </div>
                    <div class="mb-3">
                      <input type="text" class="form-control form-control-lg" placeholder="Prénom(s)" aria-label="prenoms" name="prenoms">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                      <input type="text" class="form-control form-control-lg" placeholder="Adresse" aria-label="adresse" name="adresse">
                    </div>
